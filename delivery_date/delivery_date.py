...
class SaleOrder(models.Model):
    ...
    def get_min_date(self,cr,uid, ids, context=None) :
        """Compute rules for delivery based on the sale order.
    ...
    def get_max_date(self,cr,uid, ids, context=None) :
        """Compute rules for delivery based on the sale order.
    ...
    def get_forbidden_days(self,cr,uid, ids, context=None) :
    ...
    def check_date(self, cr,uid, ids, datetime_start,context=None) :
        ...
        tzone = timezone('Europe/Brussels')
        now = pytz.utc.localize(datetime.now()).astimezone(tzone)
        min_datetime_list = self.get_min_date(cr, uid, ids, context)
        ...
        if(datetime_start.weekday() in forbidden_days) :
            ...
            return False
        forbidden_intervals = self.get_forbidden_time_intervals(cr, uid, ids, min_date=min_datetime_list, max_date=max_datetime_param)
